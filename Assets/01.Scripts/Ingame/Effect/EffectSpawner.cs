...
public class EffectSpawner : MonoBehaviour
{
    ...
    [SerializeField] private LeanGameObjectPool _feverClickEffectPool;
    ...
    public void ShowFeverClickEffect(Vector3 position)
    {
        _feverClickEffectPool.Spawn(position, Quaternion.identity, transform);
    }
